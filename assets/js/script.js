...
function changeHeaderBackgroundOnScroll() {
    ...
    // Define the scroll threshold to change the background
    const scrollThreshold = 1; // Change this value as needed

    // Check if the scroll position is greater than the threshold
    if (scrollPosition > scrollThreshold) {
        // Apply a new background color or style to the header when scrolling
        header.style.backgroundColor = ' rgba(52, 59, 64, 0.9)'; // Change this to your desired background color
    } else {
        // Reset the header background when scrolling back to the top
        header.style.backgroundColor = ""; // Change this to your initial background color
    }
}
